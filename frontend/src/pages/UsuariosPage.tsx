      ...
      <div className={`w-full max-w-lg rounded-xl bg-white p-5 shadow-xl dark:bg-slate-900 ${saliendo ? "animate-scale-out" : "animate-scale-in"}`}>
        ...
        <form onSubmit={onSubmit} autoComplete="off" className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            {previewFoto && (
              <button type="button" onClick={onQuitarFoto} className="text-xs text-slate-600 dark:text-slate-400 hover:text-red-600">
                Quitar foto
              </button>
            )}
          </div>
                  ...
                  <td className="px-4 py-2.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-600 dark:text-slate-400">@{u.nombreUsuario}</div>
                      </div>
                    </div>
                  </td>
          ...
          {filtrados.map((u) => (
            <ListCard key={u.id}>
              <div className="flex items-start gap-3">
                ...
                <div className="flex shrink-0 items-start gap-3 text-slate-600 dark:text-slate-400">
                  <button onClick={() => abrirEdicion(u)} className="hover:text-brand-600">
                    <Pencil className="h-3.5 w-3.5" />
                  </button>
                  <button
